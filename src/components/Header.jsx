...
function Header() {
  ...
  return (
    <div>
      {/* Header */}
      <header className=" lg:hidden h-[80px] z-50  duration-300 ease-in-out  p-4  dark:bg-[#46BCF9]  bg-[#46BCF9] flex items-center justify-end   ">
        {/* Logo img */}
      ...
      <div className=" z-50 hidden lg:block ">
        <div className=" fixed  z-50  w-[100px] rounded-r-3xl  flex-col  top-0 left-0 h-screen dark:bg-[#afe3fd]  bg-[#afe3fd]">
